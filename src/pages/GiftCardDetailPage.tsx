...
export default function GiftCardDetailPage() {
  ...
  useEffect(() => {
    ...
    const loadGiftCard = async () => {
      ...
      try {
        ...
        if (!card) {
          setError('Gift card não encontrado');
          setHasError(true);
        ...
        setError('Erro ao carregar dados do gift card');
        setHasError(true);
        setInitialDataLoaded(true);
      } finally {
        setLoading(false);
  ...
  // Componente de SEO para a página de detalhes
  const renderSEO = () => {
  ...
  return (
    <>
      {/* SEO com título e descrição otimizados */}
      {renderSEO()}
      
      <div className="min-h-screen bg-gray-100 flex flex-col">
        <div className="max-w-6xl w-full mx-auto bg-white rounded-3xl shadow-xl overflow-hidden mb-6">
          <Header />
          ...
          {/* Footer idêntico ao do HomeLayout, agora dentro do container principal */}
